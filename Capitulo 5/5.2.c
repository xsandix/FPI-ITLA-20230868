...
hubo cinco candidatos e imprime el total de votos que obtuvo cada
uno de ellos. */
...
void main (void)
{
    ...
    while (VOT)
    {
        ...
        la primera posicion del arreglo es 0, por esa razon a la variable VOT se
        le descuenta 1. Los votos del primer candidato se almacena en la posicion 0. */
        else
